...
const USUARIOS = [
  { uid: 'uid_hcueva',        nombre: 'Henri Apolo',       apellido: 'Cueva Jaramillo',  nombre_completo: 'Henri Apolo Cueva Jaramillo',         email: 'hcueva@uide.edu.ec',        rol: 'superadmin',    tipo_contrato: null,              carrera_id: null,                   cargo: 'Asistente de Soporte Usuario — TIC Ext. Loja', activo: true },
  { uid: 'uid_paruizag',      nombre: 'Pablo',             apellido: 'Ruiz Aguirre',     nombre_completo: 'Pablo Ruiz Aguirre',                  email: 'paruizag@uide.edu.ec',      rol: 'admin',         tipo_contrato: null,              carrera_id: null,                   activo: true },
  { uid: 'uid_locondezh',     nombre: 'Lorena Elizabeth',  apellido: 'Conde Zhingre',    nombre_completo: 'Lorena Elizabeth Conde Zhingre',      email: 'locondezh@uide.edu.ec',     rol: 'director',      tipo_contrato: 'tiempo_completo', carrera_id: 'sistemas-informacion', activo: true },
  { uid: 'uid_davalarezole',  nombre: 'Darío Javier',      apellido: 'Valarezo León',    nombre_completo: 'Darío Javier Valarezo León',          email: 'davalarezole@uide.edu.ec',  rol: 'coordinador',   tipo_contrato: 'tiempo_completo', carrera_id: 'sistemas-informacion', activo: true },
  { uid: 'uid_mipalaciosmo',  nombre: 'Milton Ricardo',    apellido: 'Palacios Morocho', nombre_completo: 'Milton Ricardo Palacios Morocho',     email: 'mipalaciosmo@uide.edu.ec',  rol: 'docente',       tipo_contrato: 'tiempo_completo', carrera_id: 'sistemas-informacion', activo: true },
  { uid: 'uid_yetorresbe',    nombre: 'Yeferson Mauricio', apellido: 'Torres Berru',     nombre_completo: 'Yeferson Mauricio Torres Berru',      email: 'yetorresbe@uide.edu.ec',    rol: 'docente',       tipo_contrato: 'medio_tiempo',    carrera_id: 'sistemas-informacion', activo: true },
  { uid: 'uid_dajaramillogu', nombre: 'Danny',             apellido: 'Jaramillo',        nombre_completo: 'Danny Jaramillo',                     email: 'dajaramillogu@uide.edu.ec', rol: 'administrativo', tipo_contrato: null,             carrera_id: null,                   cargo: 'representante_estudiantil', activo: true },
]
